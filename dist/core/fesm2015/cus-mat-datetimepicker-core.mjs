...
class MatDatetimepickerClockComponent {
  ...
  setTime(event) {
    ...
    if (this._hourView) {
      ...
      if (
        !((_a = this._hours.find(
          (h) => (h === null || h === void 0 ? void 0 : h['value']) === value
        )) === null || _a === void 0
          ? void 0
          : _a['enabled'])
      ) {
      ...
      if (
        !((_b = this._minutes.find(
          (m) => (m === null || m === void 0 ? void 0 : m['value']) === value
        )) === null || _b === void 0
          ? void 0
          : _b['enabled'])
      ) {
...
class MatDatetimepickerContentComponent {
  ...
  handleClose(val) {
    var _a;
    let newValue = (_a = this.changedDate) !== null && _a !== void 0 ? _a : val;
